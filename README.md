...
Abrir o aplicativo e selecionar a pasta do projeto.
Clique em Criar GIT. Será necessário informar a URL criada no GIT e o texto para o primeiro commit
*Para Alterar*
Abrir o aplicativo e selecionar a pasta do projeto.
Clique em Atualizar GIT. Insira o texto do commit para registro da atualização.
